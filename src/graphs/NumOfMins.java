 ...
 */
public class NumOfMins {

    /*
        Since there is a possibility than while one level's max is in progress some neighbours can
        go down to level below if they have lesser time. So we need to keep track of time for
        informing each node in each level and get max.
     */
    ...
    public static void main(String[] args) {
        NumOfMins solution = new NumOfMins();
        //7
        //6
        //[1,2,3,4,5,6,-1]
        //[0,6,5,4,3,2,1]
        solution.numOfMinutes(6,6, new int[] {1,2,3,4,5,6,-1}, new int[] {0,6,5,4,3,2,1});
    }
}
