 ...
 * seconds. More formally, an attack at second t will mean Ashe is poisoned during the inclusive time interval [t, t + duration - 1]. If
 * Teemo attacks again before the poison effect ends, the timer for it is reset, and the poison effect will end duration seconds after
 * the new attack.
 *
...
public class PoisonedDuration {
    /*
    check by contribution of each by comparing with previous except last one.
    */
