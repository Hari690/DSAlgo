...
public class BinaryTreePopulateNextRightPointerCompleteTree {

    /*
        Key is recursion already links the previous levels so when we reach next level access left and right
        and set their next pointers. See second condition were we access next
     */
    ...
    private void recur(Node root) {
        ...
        // for the condition of non-last level.
