 ...
 * Output: false
 */
public class SwapAdjacentLAndRStringWalkers {

    /*
        For `Replacing XL with LX - L should be towards left in transformed str and R should be towards right in transformed str.
